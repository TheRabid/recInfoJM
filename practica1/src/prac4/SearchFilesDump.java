...
public class SearchFilesDump {

	private SearchFilesDump() {
	}
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			if (line.startsWith("spatial")) {
				...
				// Xmin <= east
				NumericRangeQuery<Double> westRangeQuery = NumericRangeQuery.newDoubleRange("west", null, east, true,
						true);
				NumericRangeQuery<Double> eastRangeQuery = NumericRangeQuery.newDoubleRange("east", west, null, true,
						true);
				NumericRangeQuery<Double> southRangeQuery = NumericRangeQuery.newDoubleRange("south", null, north, true,
						true);
				NumericRangeQuery<Double> northRangeQuery = NumericRangeQuery.newDoubleRange("north", south, null, true,
						true);
